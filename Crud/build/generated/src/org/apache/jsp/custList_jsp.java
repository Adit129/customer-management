...
public final class custList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("              <th>Contact</th><th>Update</th><th>Delete</th>\n");
      out.write("            </tr>\n");
      out.write("            ");
                ...
                // session.setAttribute("user","null");
                 ...
                 out.println("<tr><td>"+db.rst.getString(1)+"</td><td>"+db.rst.getString(2)+"</td><td>"+db.rst.getString(3)+"</td><td>"+db.rst.getString(4)+"</td><td>"+db.rst.getString(5)+"</td><td>"+db.rst.getString(6)+"</td><td>"+db.rst.getString(7)+"</td><td>"+db.rst.getString(8)+"</td><td><a href=UpdateQues.jsp?qid="+db.rst.getString(1)+"><input type=Button value=Update></a></td>"
